...
urlpatterns = [
        ...
        ', views.sarkariresult2024, name='sarkariresult2024'), # sarkariresult2024
...
# Author
        ...
        path('authors/rajeshvari/', views.rajeshvari, name='rajeshvari'),
        path('authors/sakshi/', views.sakshi, name='sakshi'),
