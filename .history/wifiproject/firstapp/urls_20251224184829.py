...
# Author
        ...
        # path('authors/rohan-sharma/', views.rohan, name='rohansharma'),
        path('authors/priya-patel/', views.priya, name='priya'),
        # path('authors/neha-gupta/', views.neha, name='nehagupta'),
        path('about-founder-arvind-pal/', views.founder, name='founder'),
