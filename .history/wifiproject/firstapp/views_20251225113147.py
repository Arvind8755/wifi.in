...
def html_sitemap(request):
  ...
  results = Result.objects.all().order_by("-published_date")
  admitcards = Admitcard.objects.all().order_by("-published_date")
  govtupdates = Govtupdate.objects.all().order_by("-published_date")
